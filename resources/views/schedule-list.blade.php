<!-- resources/views/schedule-list.blade.php -->
<x-app-layout>
    <x-slot name="header">
                                ...
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b">
                                        ...
                                        <a href="{{ route('schedules.show', $schedule->id) }}">
                                            <button
                                                class="bg-blue-500 text-green px-4 py-2 rounded hover:bg-blue-700">詳細</button>
                                        </a>
                                        ...
                                        <form action="{{ route('schedules.destroy', $schedule->id) }}" method="POST"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="ml-2 bg-red-500 text-white px-4 py-2 rounded hover:bg-red-700">削除</button>
                                        </form>
